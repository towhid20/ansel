...
const modalViews = document.querySelectorAll('.services__modal'),
      ...
      modalClose = document.querySelectorAll('.services__modal-colse');
...
if(selectedTheme) {
    //If the validation is fulfilled, we ask what the issue was to know if we activate or deactivated the light
